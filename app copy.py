# app.py
# -------
# Dash UI + layout + app.run()

from dash import Dash, html, dcc

from trigger_dashboard_fred import (
    load_all_data,
    evaluate_triggers,
    fig_term_spread,
    fig_hy,
...
# Evaluate triggers on subset where all trigger inputs are present
triggers = evaluate_triggers(df)

# Latest date for fast indicators (rates + HY OAS)
...
app.layout = html.Div(
    ...
    children=[
        ...
        html.Div(f"Latest data (rates/HY): {last_date}", style={"textAlign": "center"}),
